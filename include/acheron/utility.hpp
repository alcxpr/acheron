...
namespace ach
{
	...
	public:
		 ...
		 */
		explicit resource(value_type v) noexcept(std::is_nothrow_move_constructible_v<value_type>) : value(std::move(v))
		{}
	...
	public:
		 ...
		 */
		explicit constexpr distinct(T v) noexcept(std::is_nothrow_move_constructible_v<T>) : data(static_cast<T &&>(v))
		{}
