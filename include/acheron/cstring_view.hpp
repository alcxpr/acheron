...
namespace ach
{
	...
	public:
		 ...
		 */
		constexpr basic_cstring_view() noexcept : sz()
		{
		...
		[[nodiscard]] constexpr int compare(std::basic_string_view<CharT, Traits> s) const noexcept
		{
	...
	template<class charT, class traits>
	constexpr void swap(basic_cstring_view<charT, traits> &lhs, basic_cstring_view<charT, traits> &rhs) noexcept
	{
		lhs.swap(rhs);
	}
